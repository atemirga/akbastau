...
--
-- Host: localhost    Database: akbastau
-- ------------------------------------------------------
...
CREATE TABLE `comments` (
  ...
  PRIMARY KEY (`id`),
  KEY `comments_proposal_id_foreign` (`proposal_id`),
...
CREATE TABLE `files` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `files_proposal_id_foreign` (`proposal_id`),
  CONSTRAINT `files_proposal_id_foreign` FOREIGN KEY (`proposal_id`) REFERENCES `proposals` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `proposals` (
  ...
  `future_state` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `status` enum('new','in_review','accepted','rejected') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'new',
...
INSERT INTO `roles` VALUES (1,'admin','web','2024-11-06 07:17:23','2024-11-06 07:17:23'),(2,'coordinator','web','2024-11-06 07:17:23','2024-11-06 07:17:23'),(3,'user','web','2024-11-06 07:17:23','2024-11-06 07:17:23');
...
CREATE TABLE `users` (
  ...
  `role` enum('employee','coordinator','admin') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'employee',
